...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 28 11:07:13 2018
...
#grid.fit(X, y)
grid = GridSearchCV(svm.SVC(kernel='rbf',decision_function_shape='ovr'), param_grid={"C":[0.1, 1, 10,100], "gamma": [1, 0.1, 0.01]}, cv=3)
...
plot_confusion_matrix(cnf_matrix
                      , classes=class_names
                      , title='Confusion matrix_svm+smoteenn')
plt.show()